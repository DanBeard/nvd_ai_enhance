...
delay_every_secs = 0.5  # delay between CVEs so we don't hit rate limits
...
utils = EnhanceUtils(CpeLookup("./NVD_DATA/nvdcpematch-1.0.json",
                               "./NVD_DATA/cpe_set.json",
                               recalc_cpe_set),
                     CveOrgLookup("./NVD_DATA/cvelistV5-main.zip"))
